...
public class RecommendationPanel extends JPanel{
	...
	/**
	 * The constructor for the RecommendationPanel
	...
	/**
	 * The visuals and initializations of the Recommendation Panel including the radio buttons, the text area, and the 
	 * questions that are needed to perform the recommendation.
	 */
	...
	/**
	 * Returns the users answers from the radiobuttons
	 * @return answer
	 */
	...
	/**
	 * Returns the users rationale from the textArea
	 * @return rationale
	 */
	...
	/**
	 * The Work performed in order to submit a Recommendation that the SubprogramPaperPanel calls.
	 * 
	 * @param u the User
	 * @param p the Paper
	 */
