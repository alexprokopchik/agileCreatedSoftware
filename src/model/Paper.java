...
public class Paper extends Observable implements Serializable{
	...
	/**
	 * @return the conference of the paper selected
	 */
	...
	/**
	 * @return the title of the paper inputed
	 */
	 ...
	 * @param s String of the title of the paper
	 */
	 ...
	 * @param s String of the abstract of the paper.
	 */
