...
public class ReviewerPaperPanel extends JPanel {
	...
	/**
	 * The constructor for the ReviewerPaperPanel.
	 * 
	 * @param finalReviewPanel The finalReviewPanel
	 * @param u The User
	 * @param p The paper
	 */
	...
	/**
	 * This checks to see if a paper has been reviewed or not and updates the JLabel to 
	...
	/**
	 * Does the work for the Review to be submitted and ads the paper to the appropriate areas.
	 */
...
//		reviewFrame.pack();
	...
	/**
	 * Does the work in order to view the paper through a text-view program.
	 */
