...
//			
	...
	/**
	 * Update method that updates the changed information and notifies the observers.
	 */
	public void update() {
		setChanged();
	...
	/**
	 * Getter for the serializable file name.
	 * @return String the Serializable file name
	 */
